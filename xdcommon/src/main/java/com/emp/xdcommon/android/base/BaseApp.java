...
public class BaseApp extends Application {
     ...
     * 销毁除欢迎界面以外的其他界面；
     */
    public void finishAllActivitys(Class ext) {
    ...
    private void registerActivitysCallbacks() {
        registerActivityLifecycleCallbacks(new ActivityLifecycleCallbacks() {
            ...
            public void onActivityStarted(Activity activity) {
                LogUtils.d(TAG, activity.getClass().getSimpleName() + " onActivityStarted");
            }

            @Override
            public void onActivityResumed(Activity activity) {
                LogUtils.d(TAG, activity.getClass().getSimpleName() + " onActivityResumed");
            }

            @Override
            public void onActivityPaused(Activity activity) {
                LogUtils.d(TAG, activity.getClass().getSimpleName() + " onActivityPaused");
            }

            @Override
            public void onActivityStopped(Activity activity) {
                LogUtils.d(TAG, activity.getClass().getSimpleName() + " onActivityStopped");
            }

            @Override
            public void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
                LogUtils.d(TAG, activity.getClass().getSimpleName() + " onActivitySaveInstanceState");
            }

            @Override
            public void onActivityDestroyed(Activity activity) {
                LogUtils.d(TAG, activity.getClass().getSimpleName() + " onActivityDestroyed");
